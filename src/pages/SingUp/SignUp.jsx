        ...
        <div className='relative'>
            <div className='relative'>
                <img 
                    src={loginImg} 
                    alt=""
                    className="object-cover w-full object-center h-[600px] mt-5 mb-5" 
                />
                <div className='w-full h-[600px] bg-black absolute top-0 left-0 opacity-[.4]'></div>
            </div>
            ...
            <div className="container px-5 py-14 mx-auto flex absolute top-0" >
                <div className="mx-auto bg-red-500 rounded-lg p-8 flex flex-col mt-8 md:mt-0 shadow-md text-white">
                    ...
                    <div className="relative mb-4">
                        ...
                        <input autoComplete='off' type="text" id="username" value={userSignUp.username} onChange={handleChange} name="username" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>          
                    ...
                    <button onClick={handleSignUp} className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                    <p className='text-xs text-white mt-5'>
                        Do you have an account? 
                        <Link to='/login'><button className='cursor-pointer hover:text-blue-300'>
                             &nbsp;Login
                        </button></Link> 
                    </p>
                </div>
